...
class GPUModelRunner(
    ...
    def __init__(
        ...
        self._ep_all2all_manager = None
        if parallel_config.data_parallel_size > 1 and self.model_config.is_moe:
            self._ep_all2all_manager = get_ep_all2all_manager()
    ...
    def sample_tokens(
        ...
        with record_function_or_nullcontext(
            ...
            async_output = AsyncGPUModelRunnerOutput(
                ...
                check_ep_fault=(
                    self._ep_all2all_manager is not None
                    and self._ep_all2all_manager.support_fault_tolerance
                ),
            )
        with record_function_or_nullcontext(
